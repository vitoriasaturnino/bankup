defmodule Bankup.ClientsTest do
  ...
  describe "clients" do
    ...
    test "create_client/1 with valid data creates a client" do
      valid_attrs = %{state: "some state", full_name: "some full_name", cpf_cnpj: "some cpf_cnpj", email: "some email", phone: "some phone", whatsapp: "some whatsapp", country: "some country", city: "some city", postal_code: "some postal_code", street_address: "some street_address", birth_date: ~D[2024-10-04]}
      ...
      assert client.birth_date == ~D[2024-10-04]
    end
    ...
    test "update_client/2 with valid data updates the client" do
      ...
      assert client.birth_date == ~D[2024-10-05]
    end
