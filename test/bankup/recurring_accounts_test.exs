defmodule Bankup.RecurringAccountsTest do
  ...
  describe "recurring_accounts" do
    ...
    test "create_recurring_account/1 with valid data creates a recurring_account" do
      ...
      assert {:ok, %RecurringAccount{} = recurring_account} =
               RecurringAccounts.create_recurring_account(valid_attrs)
    ...
    test "create_recurring_account/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               RecurringAccounts.create_recurring_account(@invalid_attrs)
    end
    ...
    test "update_recurring_account/2 with valid data updates the recurring_account" do
      ...
      update_attrs = %{
        ...
        pix_key: "some updated pix_key"
      }

      assert {:ok, %RecurringAccount{} = recurring_account} =
               RecurringAccounts.update_recurring_account(recurring_account, update_attrs)
    ...
    test "update_recurring_account/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               RecurringAccounts.update_recurring_account(recurring_account, @invalid_attrs)
    ...
    test "delete_recurring_account/1 deletes the recurring_account" do
      ...
      assert {:ok, %RecurringAccount{}} =
               RecurringAccounts.delete_recurring_account(recurring_account)

      assert_raise Ecto.NoResultsError, fn ->
        RecurringAccounts.get_recurring_account!(recurring_account.id)
      end
    end
