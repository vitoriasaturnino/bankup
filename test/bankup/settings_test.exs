defmodule Bankup.SettingsTest do
  ...
  describe "settings" do
    ...
    test "create_setting/1 with valid data creates a setting" do
      valid_attrs = %{notification_preference: "some notification_preference", penalty_limit: "120.5", reminder_frequency: 42}
      ...
      assert setting.penalty_limit == Decimal.new("120.5")
    ...
    test "update_setting/2 with valid data updates the setting" do
      setting = setting_fixture()
      update_attrs = %{notification_preference: "some updated notification_preference", penalty_limit: "456.7", reminder_frequency: 43}
      ...
      assert setting.penalty_limit == Decimal.new("456.7")
