defmodule Bankup.NotificationsTest do
  ...
  describe "notifications" do
    ...
    test "create_notification/1 with valid data creates a notification" do
      valid_attrs = %{channel: "some channel", content: "some content", sent_at: ~U[2024-10-04 19:26:00Z], delivery_status: "some delivery_status"}
      ...
      assert notification.sent_at == ~U[2024-10-04 19:26:00Z]
    ...
    test "update_notification/2 with valid data updates the notification" do
      notification = notification_fixture()
      update_attrs = %{channel: "some updated channel", content: "some updated content", sent_at: ~U[2024-10-05 19:26:00Z], delivery_status: "some updated delivery_status"}
      ...
      assert notification.sent_at == ~U[2024-10-05 19:26:00Z]
